...
CREATE TABLE paymethod (
    paymethod_id   NUMBER(2) NOT NULL,
...
ALTER TABLE rent ADD CONSTRAINT rent_nk UNIQUE ( rent_lease_start,
                                                 prop_no );
